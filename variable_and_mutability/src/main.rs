...
//
// ===Variables===
// Variables are container which store values, like a fruit-basket contain fruits , like your body
...
// If you don't understand what is a keyword is -> Brother you need some recall pill we have
...
// ex: let we_have_monkey_eating_banana_and_number_of_banana_is = 5. -> this is verbose , don't do
// this
//
// instead do this :-
// let
...
// bless_our_poor_dummies = 5.
//
// Just kidding , No violence (just peace and violin.)
// Here how you do that :-
// let banana = 5
//
// here you noticed I didn't used spaces because I was following snake naming convention or snake
// case.
//
// like we use naming convention to create file name , similarly you use rust naming convention to
// write name of variables
//
// Before someone asks what is a naming convention ->
// That's just means a rule or style(you can say).
// You have to follow while adopting a new language.
// For every language this naming convention changes accordingly.

// When I heard about it , I thought same -> why don't they standardize it , and make it universal
// for every language.
//
// but nonetheless , it doesn't matter.
//
// so rust naming convention is to follow snake_case (that's just the name of naming convention, my
// personal favorite is camelCase because I came from java background.)
//
// so in snake case , you don't use capital letter in the word(except for constant, that's just
...
fn main() {
    ...
    // brackets.
    //
    // currently this variable doesn't have any value so if you print it , it won't show anything on
    ...
    // something to print since it hasn't anything in it , it will produce error.
    ...
    // cannot be changed by default , that mean , if you reinitialize a variable , it won't work and
    // produce error.
    //
    ...
    // produce error ?
    // because the first time we declare and initialize it ,
    // rust compiler was smart enough to tell that it was empty.
    // And afterward, we added value to it.
    ...
    // rust compiler is a program that turn our code into machine code.
    //
    ...
    // We can do so using "mut" keyword.
    // we will use this keyword when we are declaring the
    ...
    //
    // also note we can declare and initialize it in one line , like we have done it earlier.
